...
parser = ArgumentParser(description="Evaluate IMG")
parser.print_help()
parser.add_argument("--i", dest="filename", required=False,
    help="input file name", metavar="FILE", default = 'Subset1_Test_24')
...
param=torch.load("/data/acharl15/gleason_grading/result/training_saved_model/subset1_pretrain_100epoch_normalized_Imagenet_balanced_relu_dropout_SGD_augment/checkpoint/checkpoint_epoch36.pth")
#print(param)
