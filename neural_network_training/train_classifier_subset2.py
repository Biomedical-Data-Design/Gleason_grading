...
#################### output
out_dir = "/data/acharl15/gleason_grading/result/training_saved_model/subset2_pretrain_100epoch_normalized_Imagenet_balanced_relu_dropout_SGD_augment/"
isExist = os.path.exists("/data/acharl15/gleason_grading/result/training_saved_model/subset2_pretrain_100epoch_normalized_Imagenet_balanced_relu_dropout_SGD_augment/checkpoint")
if not isExist:
    print("new_directory")
    os.makedirs("/data/acharl15/gleason_grading/result/training_saved_model/subset2_pretrain_100epoch_normalized_Imagenet_balanced_relu_dropout_SGD_augment/checkpoint")
...
wandb.init(
    ...
    project="gleason-grading-subset1",name = 'Experiment 11_2',
...
model = Model_name()
### utilize GPU
param=torch.load("/data/acharl15/gleason_grading/result/training_saved_model/subset2_pretrain_100epoch_normalized_Imagenet_balanced_relu_dropout_SGD_augment/checkpoint/checkpoint_epoch99.pth")
#print(param)
...
for epoch in range(100,500):  # loop over the dataset multiple times
    model.train()
