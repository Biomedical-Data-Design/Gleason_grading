...
parser.add_argument("--i", dest="filename", required=False,
    help="input original image", metavar="FILE", default = 'Subset1_Train_10.tiff')
parser.add_argument('--annotation', dest="annotation_dir", required=False,
    help="annotation directory", default = 'Subset1_Train_10')
parser.add_argument('--output', dest="output_dir", required=False,
    help="output directory",default = 'Subset1_Train_10')
...
ann_dir = os.path.join("/Users/anany/Desktop/gleason-grading/"+args.filename[0:7]+"_Train_annotation/"+ args.annotation_dir+"/")
